...
Этот код визуализирует карту пространственных частот изображения, показывая области с высокой и низкой интенсивностью спектра.
# Лаба 3
# Лаба 4
...
Основные особенности:
 1. Выходной диапазон: Значения функции находятся в диапазоне .
 2. Применение:
